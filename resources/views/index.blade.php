            ...
            <div class="grid sm:grid-cols-12 grid-cols-2 gap-8  mt-10">
                <div class="col-span-8">
                    <div class="bg-gray-600 relative w-full mt-8">
                        <img class="w-full h-64 object-cover mix-blend-overlay" src="{{ asset($posts[0]['thumbnail'] ? 'storage/thumbnail/'. $posts[0]['thumbnail'] : 'default/default.jpg' ) }}" alt="">
                    ...
                    <div class="mt-10 grid grid-cols-1  md:grid-cols-2 gap-5">
                       @foreach ($posts as $post)
                            @if ($loop->iteration <= 8)
                            <div class="">
                            <img class="h-32 w-full object-cover object-center" src="{{ asset($post['thumbnail'] ? 'storage/thumbnail/'. $post['thumbnail'] : 'default/default.jpg' ) }}" alt="">
                                <div class="mt-5">
                                    <div>
                ...
                <div class="col-span-8">
                    @foreach ($posts as $post)
                        ...
                        <div class="mt-10 flex md:flex-row flex-col space-x-0 md:space-x-8">
                            <img width="300" height="" class="w-full h-32 md:w-[300px]" src="{{ asset($post['thumbnail'] ? 'storage/thumbnail/'. $post['thumbnail'] : 'default/default.jpg' ) }}" alt="">
                            <div class="mt-3">

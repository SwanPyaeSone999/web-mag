                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr>
                                            <td class="px-6 py-4 whitespace text-sm text-gray-500">{{$category['id']}}</td>
                                            <td class="px-6 py-4 whitespace text-sm text-gray-500">{{$category['name']}}</td>
                                            <td class="px-6 py-4 whitespace text-sm text-gray-500">{{$category['created_at']->format('M d Y')}}</td>
                                            <td class="px-6 py-4 whitespace text-sm  flex ">
                                                <a href="{{ route('admin.category.edit',$category['id']) }}" class="text-yellow-400">Edit</a>   |
